...
from LAB.common.setting import configuration
...
class Provider:
    ...
    def create(self, start_path, data_folder, roi_list):

        file_list = os.listdir(data_folder)
        file_list.sort()
        file_list_img = [file for file in file_list if file.endswith(configuration.IMAGE_EXTENSION)]

...
class CrossButton(QHBoxLayout):
    ...
    pushButton2: object      # left button
    pushButton4: object      # top button
    pushButton5: object      # center button
    pushButton6: object      # down button
    pushButton8: object      # right button
